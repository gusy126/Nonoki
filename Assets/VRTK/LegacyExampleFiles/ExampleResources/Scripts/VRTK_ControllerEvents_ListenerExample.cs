namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerEvents_ListenerExample : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage(VRTK_Logger.CommonMessageKeys.REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT, "VRTK_ControllerEvents_ListenerExample", "VRTK_HandAnimator", "the same"));
                return;
            }
        ...
        private void DoTouchpadPressed(object sender, ControllerInteractionEventArgs e)
        {
            if (touchpadButtonEvents)
            {
                ...
                //float currentWeight = Mathf.Lerp(handAnimator.GetLayerWeight(1), 1.0f, Time.deltaTime);
                //handAnimator.SetLayerWeight(1, currentWeight);
